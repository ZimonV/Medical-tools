...
textos = {
    ...
    "fecha_buscar": "Date to search (format DD/MM/YYYY): ",
    "todos_buscar": ["First name: ", "Last name: ", "Age: ", "Diagnosis: ", "Date (format DD/MM/YYYY): "],
    ...
    "nueva_fecha": "New date (format DD/MM/YYYY, leave blank to keep): ",
